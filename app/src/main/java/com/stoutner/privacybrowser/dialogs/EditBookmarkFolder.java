...
public class EditBookmarkFolder extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        long[] selectedBookmarkLongArray = Bookmarks.checkedItemIds;
        ...
        Cursor bookmarkCursor = Bookmarks.bookmarksDatabaseHelper.getBookmarkCursor(selectedBookmarkDatabaseId);
        ...
        // Get a `Bitmap` of the favorite icon from `MainWebView` and display it in `edit_folder_web_page_favorite_icon`.
        ...
        webPageFavoriteIconImageView.setImageBitmap(MainWebView.favoriteIcon);
